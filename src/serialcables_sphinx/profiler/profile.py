...
class CapturedCommand:
    ...
    config_id_name: Optional[str] = None
    
    # For admin tunneled commands
    admin_opcode: Optional[int] = None
    admin_opcode_name: Optional[str] = None
...
class ProfileMetadata:
    ...
    sphinx_version: str = ""
    hydra_version: str = ""
    hydra_firmware_version: Optional[str] = None
    ...
    nvme_mi_major_version: Optional[int] = None
    nvme_mi_minor_version: Optional[int] = None
...
class DeviceProfile:
    ...
    def load(cls, filepath: str) -> DeviceProfile:
        ...
        if not profile.verify_checksum():
            print(f"WARNING: Profile checksum mismatch - file may be corrupted")
