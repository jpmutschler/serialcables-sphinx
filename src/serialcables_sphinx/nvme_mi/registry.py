...
class DecoderRegistry:
    ...
    _decoders: Dict[Tuple[int, Optional[int]], Type["ResponseDecoder"]] = {}
    
    # Vendor-specific decoders: {vendor_id: {(opcode, data_type): decoder_class}}
    _vendor_decoders: Dict[int, Dict[Tuple[int, Optional[int]], Type["ResponseDecoder"]]] = {}
