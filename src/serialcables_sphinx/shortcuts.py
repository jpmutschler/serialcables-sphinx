...
if TYPE_CHECKING:
    from serialcables_hydra import JBOFController
    from serialcables_hydra.controller import NVMeSerialNumber, NVMeHealthStatus
...
class SerialNumberResult:
    ...
    decoded: Optional[DecodedResponse] = None
...
class HealthStatusResult:
    ...
    slot: int
    success: bool
    temperature_kelvin: Optional[int] = None
    ...
    def scan_all_slots(
        ...
        for slot in range(1, 9):
            try:
                ...
                results.append(SerialNumberResult(
                    slot=slot,
                    serial_number="",
                    success=False,
                    error=str(e),
    ...
    def health_check_all_slots(
        ...
        for slot in range(1, 9):
            try:
                ...
                results.append(HealthStatusResult(
                    slot=slot,
                    success=False,
                    error=str(e),
                ))
